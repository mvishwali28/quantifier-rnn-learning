...
cat("group","step", "direction", "all_acc", "only_acc", "t", "p\n", file="stats_output_3_runs.csv", sep = ",")

t_test_sweep_steps("\\30k\\exp-1-a", 
                   1, 3001, group = "10k-4c:0nc", output_file = "stats_output_3_runs.csv")

t_test_sweep_steps("\\30k\\exp-1-b", 
                   1, 3001, group = "10k-3c:1nc",  output_file = "stats_output_3_runs.csv")

t_test_sweep_steps("\\30k\\exp-1-c", 
                   1, 3001, group = "10k-2c:2nc",  output_file = "stats_output_3_runs.csv")

t_test_sweep_steps("\\30k\\exp-1-d", 
                   1, 3001, group = "10k-1c:3nc", output_file = "stats_output_3_runs.csv")

t_test_sweep_steps("\\30k\\exp-1-e", 
                   1, 3001, group = "10k-0c:4nc", output_file = "stats_output_3_runs.csv")
