...
#SBATCH --output=experiment_oned.out
#SBATCH --gres=gpu:1
...
#PYTHONPATH=$PYTHONPATH:.python quant_verify_exp1.py --exp one_d --out_path data/<dir>
...
cat experiment_oned.out > terminal_results.txt
